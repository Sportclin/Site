...
class ciencia extends MY_Controller {
    ...
    function index($sucesso = NULL) {
        ...
        $conteudo['ciencia'] = $this->ciencia_model->listar($where = array(), $perpage = 0, $start = 0);

        $this->load->view('/templates/admin/admin_header', $this->header);
        $this->load->view('/templates/admin/ciencia_view', $conteudo);
    ...
    function novo() {
        ...
        $this->load->view('/templates/admin/admin_header', $this->header);
            $this->load->view('/templates/admin/ciencia_novo');
        $this->load->view('/templates/admin/admin_footer');
    }
